...
******************************************************************/
const greaterThan25 = temperatures.filter(degree=>{return degree>=25});
//console.log(greaterThan25);

const lessThan20 = temperatures.filter(degree=>{return degree<20});
...
*/
TempList=[71.6, 77, 66.2, 75.2,82.4, 86, 69.8, 68,
80.6, 84.2, 73.4, 78.8,75.2, 71.6, 64.4, 66.2, 
69.8, 82.4, 86, 80.6,78.8, 77, 71.6, 73.4, 
66.2, 68, 82.4, 84.2,80.6, 78.8]

FahrenheitList= TempList.map(element=>{return (element*9/5)+32})
//console.log(FahrenheitList);
...
const labelList = temperatures.map(element => {
    if (element>=25){
        return "warm";
    }
...
******************************************************************/
const HighestTemp= temperatures.reduce((currentmax,element)=>{
...
const lowestTemp= temperatures.reduce((currentMin,element)=>{
